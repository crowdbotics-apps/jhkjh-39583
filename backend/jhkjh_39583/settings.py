"""
Django settings for jhkjh_39583 project.
...
WSGI_APPLICATION = 'jhkjh_39583.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jhkjh_39583 API",
    "DESCRIPTION": "API documentation for jhkjh_39583 App",
    "VERSION": "v1",
}
